  ...
  <header>
    <div class="container">
        ...
        <div class="search" ref="searchWrapper">
          ...
          >
            <div
              ...
              @click="handleSearchItemClick(searchProduct.id)"
            >
              <RouterLink class="product__list-link">
                {{ searchProduct.name }}
              </RouterLink>
            </div>
          </div>
      ...
      <nav>
        ...
        <RouterLink to="/products"><span>Афиша</span></RouterLink>
        <RouterLink to="/contact"><span>Контакты</span></RouterLink>
        <RouterLink to="/team"><span>Команда</span></RouterLink>
      </nav>
    </div>
  </header>
</template>
